...
const environmentSchema = z.object({
  ...
  ENROLLMENT_DATABASE_URL: z.url().default(DEFAULT_ENROLLMENT_DATABASE_URL),
  ENROLLMENT_COURSE_BASE_URL: z.url().default(DEFAULT_ENROLLMENT_COURSE_BASE_URL),
  ENROLLMENT_COURSE_TIMEOUT_MS: z.coerce
    .number()
    .int()
    .min(1)
    .max(60_000)
