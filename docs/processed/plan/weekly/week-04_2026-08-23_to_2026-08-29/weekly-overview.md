...
| [task-03_define-data-ownership-and-fault-matrix](task-03_define-data-ownership-and-fault-matrix.md) | Chốt data ownership, dependency strategy và fault matrix MVP | Bách | Đức | Cao | Chờ review |
