...
| [task-05_define-evaluation-protocol](task-05_define-evaluation-protocol.md) · [PR #13](https://github.com/Minhduc7904/DO_AN_TOT_NGHIEP/pull/13) | Chốt experiment metadata, dataset split và evaluation protocol v0 | Bách | Đức | Cao | Chờ review |
