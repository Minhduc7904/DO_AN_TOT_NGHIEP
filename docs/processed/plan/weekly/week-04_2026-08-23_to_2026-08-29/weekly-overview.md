...
| --- | --- | --- | --- | --- | --- |
| [task-01_define-service-topology](task-01_define-service-topology.md) | Chốt service catalogue, dependency graph và architecture diagram v1 | Đức | Bách | Cao | Đã giao |
| [task-02_define-http-and-event-contracts](task-02_define-http-and-event-contracts.md) | Thiết kế HTTP contract và event `grade.completed` v1 | Đức | Bách | Cao | Đang thực hiện |
