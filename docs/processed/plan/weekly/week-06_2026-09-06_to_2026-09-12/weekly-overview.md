...
| [task-05_add-course-cache-and-telemetry](task-05_add-course-cache-and-telemetry.md)   | Bổ sung Redis cache và telemetry dependency cho Course    | Đức             | Bách         | Cao     | Đang thực hiện |
...
| Task 5 — Course cache/telemetry | [#23](https://github.com/Minhduc7904/DO_AN_TOT_NGHIEP/pull/23) | Draft; nhánh lấy base task-04, chờ CI và review của Bách |
