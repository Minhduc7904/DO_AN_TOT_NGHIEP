...
| [task-03_verify-enrollment-workflow](task-03_verify-enrollment-workflow.md) | Kiểm chứng E2E login → enroll qua Gateway | Đức | Bách | Trung bình | Chờ review |
...
- [#27](https://github.com/Minhduc7904/DO_AN_TOT_NGHIEP/pull/27) — `task-03_verify-enrollment-workflow`, base `main` (nội dung xếp chồng trên #26, #25, cả hai đã merge), `Chờ review` (chờ Bách chạy độc lập và review).
