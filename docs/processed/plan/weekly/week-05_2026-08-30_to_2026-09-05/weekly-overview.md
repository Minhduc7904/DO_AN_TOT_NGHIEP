...
| [task-04_establish-ci-and-fresh-setup-gate](task-04_establish-ci-and-fresh-setup-gate.md) | Thiết lập CI baseline và kiểm chứng fresh setup | Bách | Đức | Cao | Chờ xử lý |
