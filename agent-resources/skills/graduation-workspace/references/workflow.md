...
- Khi người phụ trách đã hoàn thiện work, bằng chứng DoD và PR, người phụ trách cập nhật task sang `Chờ review` theo [vòng đời task canonical](../../../../docs/processed/rules/git-and-pull-request-rules.md#vòng-đời-task-canonical).
...
- Khi người phụ trách xử lý feedback trên PR của chính task, đọc `pr-review-response`; sau khi review lại đạt và PR đã merge vào nhánh canonical, đọc `task-completion-recording` để người phụ trách ghi nhận `Hoàn thành`.
...
- Task chỉ đủ điều kiện hoàn thành khi mọi DoD được đánh dấu đạt, sản phẩm có thể truy cập, thời gian được ghi, review đã đạt, PR đã merge vào nhánh canonical và completion record đã được người phụ trách cập nhật.
