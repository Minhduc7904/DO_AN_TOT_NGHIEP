...
- Khi người phụ trách xử lý feedback trên PR của chính task, đọc `pr-review-response`. Quy trình chuẩn chờ GitHub `APPROVED` trước finalization; nếu đúng người phụ trách yêu cầu ngoại lệ sau cảnh báo, dùng `task-completion-recording` và ghi nguồn xác nhận thay thế.
...
- Quy trình chuẩn finalization trên branch task trước merge khi DoD và GitHub approval đã đủ. Nếu người phụ trách chỉ thị khác, cảnh báo rồi thực hiện correction hợp lệ theo rule canonical, ghi rõ cổng bị thiếu và nguồn xác nhận; không giả mạo dữ liệu.
