...
Khi tạo tuần mới, break task, phân công hoặc cập nhật overview/card, chạy `tools/sync-plan-json-and-timeline.ps1` sau thay đổi Markdown. Nếu runtime hoặc script lỗi, cảnh báo; khi đúng người phụ trách xác nhận tiếp tục, được commit Markdown theo ngoại lệ và báo timeline đang chờ đồng bộ. Không sửa trực tiếp JSON hoặc HTML đã sinh.
