...
1. **Hỏi sản phẩm trước.** Hỏi người dùng sản phẩm/đường dẫn/link thực tế là gì, đã bắt đầu và hoàn thành lúc nào, cùng thay đổi phạm vi hoặc tồn đọng nếu có. Không cập nhật trạng thái hoàn thành ở bước này.
...
3. **Đánh giá.** Nếu bất kỳ DoD nào chưa đạt, giữ card ở `Đang thực hiện` hoặc `Chờ xử lý`, ghi phần còn thiếu và không tạo output hoàn thành. Nếu mọi DoD đạt và sản phẩm mở được, tiếp tục bước 4.
...
5. **Cập nhật hai nơi.** Input ghi mục tiêu, phạm vi, phụ thuộc, sản phẩm dự kiến và DoD từ card. Nếu tạo sau khi người dùng đã làm xong, ghi rõ ở nội dung rằng đây là **ghi nhận hồi tố**. Output ghi thời gian thực tế, sản phẩm thực tế, từng DoD và bằng chứng người dùng xác nhận. Sau đó đổi card task thành `Hoàn thành`, gắn link input/output và cập nhật hàng trạng thái trong `weekly-overview.md`.
