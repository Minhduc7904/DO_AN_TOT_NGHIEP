...
Khi người dùng yêu cầu rõ, reviewer được đăng nhận xét inline vào các dòng thay đổi của pull request. Reviewer chỉ review và phản hồi; không tự cập nhật trạng thái card/output hoặc gắn link PR thay người phụ trách task.
