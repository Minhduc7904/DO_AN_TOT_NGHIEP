...
| Ngày tạo | 30/08/2026 |
| Thời gian dự kiến | Làm bù sau tuần 4; thời lượng cụ thể sẽ chốt trước khi bắt đầu nội dung chính. |
| Nhánh thực hiện | `docs/week-04/task-05-define-evaluation-protocol` |
| Pull request dự kiến | Chưa tạo; sẽ mở từ nhánh task sau khi có artifact đạt DoD. |
